...
func TestLimitVerifier(t *testing.T) {
	...
	tests := []struct {
...

		{
			...
			isEvaluator: makeISEvaluator(1, 0),
			expected:    field.ErrorList{field.InternalError(field.NewPath("<none>"), makeISForbiddenError("is", []kapi.ResourceName{api.ResourceImageStreamImages}))},
		},

		{
			...
			expected:    field.ErrorList{field.InternalError(field.NewPath("<none>"), makeISForbiddenError("is", []kapi.ResourceName{api.ResourceImageStreamTags}))},
		},

		{
			...
			isEvaluator: makeISEvaluator(0, 0),
			expected:    field.ErrorList{field.InternalError(field.NewPath("<none>"), makeISForbiddenError("is", []kapi.ResourceName{api.ResourceImageStreamImages, api.ResourceImageStreamTags}))},
		},
	}
