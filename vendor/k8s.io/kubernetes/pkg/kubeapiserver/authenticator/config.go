...
func (config Config) New() (authenticator.Request, *spec.SecurityDefinitions, error) {
	...
	tokenAuthenticators = AddOAuthServerAndLegacyServiceAccountAuthenticatorIfNeeded(tokenAuthenticators, config.APIAudiences, config.ServiceAccountTokenGetter)
